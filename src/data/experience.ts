...
export const experience: Experience[] = [
  {
    ...
    highlights: [
      ...
      "Rebuild the corporate website as a server-rendered Express/EJS/PostgreSQL application (20+ pages) on a normalized ~17-table schema with transactional migrations, plus a config-driven admin CMS generating full CRUD for 13 content types from a single schema file.",
      "Containerize the platform with a multi-stage Docker build and automated Fly.io deployments through GitHub Actions, securing it with bcrypt session auth, a Postgres-backed session store, and parameterized SQL throughout.",
